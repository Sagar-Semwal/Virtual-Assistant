...
const SignIn = () => {
  ...
  return (
    ...
    >
      ...
      {/* Blue Glow */}
      <div className="absolute right-20 top-1/2 h-[550px] w-[550px] -translate-y-1/2 rounded-full bg-cyan-500/10 blur-[150px]" />
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="mt-4 text-gray-300 leading-relaxed">
              Sign in to continue building your AI Voice Assistant.
            </p>
